...
{ 
    ...
    { 
        ...
        $article->save(); 
        header('Location:/серв_разработка/Project/www/articles'); 
    } 
    ...
    { 
        ...
        $article->setAuthorId($_POST['authorId']); 
        $article->save(); 
        header('Location:/серв_разработка/Project/www/article/' . $article->getId()); 
    } 
    ...
    { 
        ...
        if ($article !== null) { 
            ...
            $articleComments = array_filter($comments, function ($comment) use ($article) { 
                return $comment->getArticleId() === $article->getId(); 
            }); 
